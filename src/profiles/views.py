...
class ProfileCreateView(LoginRequiredMixin, CheckAuthProfileMixin, CreateView):
  ...
  def form_valid(self, form):
    ...
    messages.success(self.request, 'Профиль был успешно создан!')
...
class ProfileUpdateView(
  ...
  def get_success_url(self, *args, **kwargs):
    messages.success(self.request, 'Профиль был успешно обновлен!')
    return reverse(
...
class ProfileDeleteView(
  ...
  def get_success_url(self, *args, **kwargs):
    messages.success(self.request, 'Профиль был успешно удален!')
...
class EducationUpdateView(
  ...
  def get_success_url(self, *args, **kwargs):
    messages.success(self.request, 'Образование успешно обновлено!')
    return reverse(
...
class EducationDeleteView(
  ...
  def get_success_url(self, *args, **kwargs):
    messages.success(self.request, 'Образование было успешно удалено!')
    return reverse(
...
class EducationCreateView(
  ...
  def form_valid(self, form):
    if self.get_object():
      ...
      messages.success(self.request, 'Образование успешно создано!')
...
class ExperienceCreateView(LoginRequiredMixin, ProfileObjectMixin, CreateView):
  ...
  def form_valid(self, form, *args, **kwargs):
    if self.get_object():
      form.instance.profile = self.get_object()
      messages.success(self.request, 'Опыт был успешно создан!')
...
class ExperienceUpdateView(
  ...
  def get_success_url(self, *args, **kwargs):
    messages.success(self.request, 'Опыт был успешно обновлен!')
    return reverse(
...
class ExperienceDeleteView(
  ...
  def get_success_url(self, *args, **kwargs):
    messages.success(self.request, 'Опыт был успешно удален!')
    return reverse(
...
class SocialCreateView(LoginRequiredMixin, ProfileObjectMixin, CreateView):
  ...
  def form_valid(self, form, *args, **kwargs):
    form.instance.profile = self.get_object()
    messages.success(self.request, 'Социальная страница была успешно создана!')
...
class SocialUpdateView(
  ...
  def get_success_url(self, *args, **kwargs):
    messages.success(self.request, 'Социальная страница была успешно обновлена!')
    return reverse(
...
class SocialDeleteView(
  ...
  def get_success_url(self, *args, **kwargs):
    messages.success(self.request, "Социальная страница была успешно удалена! Давайте создадим один")
    return reverse(
